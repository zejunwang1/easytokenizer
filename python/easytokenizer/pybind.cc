...
std::pair<std::vector<std::string>, std::vector<Offset>> tokenize(
    tokenizer::Tokenizer& m, const std::string& text) {
  std::vector<std::string> tokens;
  std::vector<Offset> offsets;
  m.wordpiece_tokenize(text, tokens, offsets);
  return std::pair<std::vector<std::string>, std::vector<Offset>>(tokens, offsets);
}

std::pair<std::vector<int64_t>, std::vector<Offset>> single_encode(
    tokenizer::Tokenizer& m, const std::string& text, 
  ...
  return std::pair<std::vector<int64_t>, std::vector<Offset>>(input_ids, offsets);
}
...
std::tuple<std::vector<std::vector<int64_t>>,
  ...
  return std::tuple<std::vector<std::vector<int64_t>>,
           std::vector<std::vector<int64_t>>,
           std::vector<std::vector<int64_t>>,
